...
bool lab2_1_intefaces_custom__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lab2_1_intefaces_custom.msg._sphere", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("Sphere", (char *)PyUnicode_1BYTE_DATA(name_attr), 6) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  lab2_1_intefaces_custom__msg__Sphere * ros_message = _ros_message;
  {  // center
...
PyObject * lab2_1_intefaces_custom__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lab2_1_intefaces_custom.msg._sphere");
